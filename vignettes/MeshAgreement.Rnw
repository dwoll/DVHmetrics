...
# remotes::install_github(c("stla/SurfaceReconstruction"))
...
## data_heart_meshL: list of sample meshes included in MeshAgreement
agreeW <- get_mesh_agree(data_heart_meshL, silent=TRUE)
agreeW
@
